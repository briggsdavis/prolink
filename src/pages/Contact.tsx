      ...
      <section className="bg-white border-b py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <span className="text-primary-blue font-bold uppercase tracking-[0.3em] text-sm mb-6 block">
              Get In Touch
            </span>
            ...
            <p className="text-slate-500 text-2xl leading-relaxed max-w-2xl">
              Have questions about our products or bulk export solutions? Our
              team is here to help you navigate global trade with ease.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-24">
            ...
            <div className="lg:col-span-1 space-y-16">
              <div>
                ...
                <div className="space-y-12">
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      <span className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-2 block">
                        Phone
                      </span>
              ...
              <div className="p-12 bg-white border border-slate-100 relative overflow-hidden">
                ...
                <h4 className="text-2xl font-bold mb-6 tracking-tight text-slate-900">
                  Global Support
                </h4>
